...
import type { Hub } from 'dom-native';
...
export function pubHub1Topic1() {
	...
	equal(out, ["HUB1_TOPIC_1 >> HUB1_TOPIC_1-undefined-sendHub1Topic1"]);
}

export function pubHub1Topic1Label1() {
	hub1.pub("HUB1_TOPIC_1", "hub1_label_1", "sendHub1Topic1Label1");
	equal(out, ["HUB1_TOPIC_1; hub1_label_1 >> HUB1_TOPIC_1-hub1_label_1-sendHub1Topic1Label1",
		"HUB1_TOPIC_1 >> HUB1_TOPIC_1-hub1_label_1-sendHub1Topic1Label1"]);
}
