...
import { type DemoFamily, DOM_NATIVE_FAMILY, DND_FAMILY, DEFAULT_SPEC_BY_FAMILY, SPEC_NAMES_BY_FAMILY, DOM_NATIVE_TEST_FAMILY, DOM_NATIVE_TEST_SPEC_NAMES, DEFAULT_DOM_NATIVE_TEST_SPEC, VALID_DOM_NATIVE_TEST_SPECS, DOM_NATIVE_UI_FAMILY } from "./spec-config.js";
...
function _render() {
	...
	<header>
		...
		<a class="item dnd" href="#dnd/${DEFAULT_SPEC_BY_FAMILY[DND_FAMILY]}">draggable</a>
...
function _parseRoute(hash: string): { family: DemoFamily | typeof DOM_NATIVE_TEST_FAMILY; spec: string } | null {
	...
	if (familyRaw !== DOM_NATIVE_FAMILY && familyRaw !== DND_FAMILY && familyRaw !== DOM_NATIVE_TEST_FAMILY && familyRaw !== DOM_NATIVE_UI_FAMILY) {
		return null;
	}
